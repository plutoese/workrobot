...
"""
=========================================
MongoDB数据库的provincestat集合
=========================================

:Author: glen
:Date: 2016.7.24
:Tags: mongodb database collection
:abstract: 对provincestat集合进行具体操作

**类**
==================
MonDBProvinceStat
    对provincestat集合进行具体操作

**使用方法**
==================
MonDBProvinceStat提供变量列表打印，变量查询等功能
...
class MonDBProvinceStat(MonCollection):
    """ 对provincestat集合进行具体操作
    ...
    def acode_and_region(self):
        return dict(set([(item['acode'],item['province'])
                         for item in self.find({},projection={'_id':0,'acode':1,'province':1})]))
    ...
    def info(self):
        ...
        """
        print('='*80)
        print('Collection provincestat infomation')
        print('Variables: ')
        i = 1
...
if __name__ == '__main__':
    ...
    print(prostat.acode)
    #print(prostat.acode_and_region)
    prostat.info()
